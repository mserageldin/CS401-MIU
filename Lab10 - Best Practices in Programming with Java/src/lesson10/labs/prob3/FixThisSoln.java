...
import lesson10.labs.prob3.FunctionWithException;
import lesson10.labs.prob3.FixThis.InputTooLongException;
public class FixThisSoln {
	...
	public static void main(String[] args) {
		...
		System.out.println(ft.processList(Arrays.asList("This","not", "too", "big", "yet")));
