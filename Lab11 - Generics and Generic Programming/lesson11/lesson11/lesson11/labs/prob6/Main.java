...
public class Main {
	...
	public static <T> boolean contains2(List<T> list, T s, Comparator<T> cmp) {
		for (T x : list) {
			if (x == null && s == null)
				return true;
			if (s == null || x == null)
				continue;
			if (cmp.compare(x, s) == 0)
				return true;
		}
		return false;
	}
	...
	public static void test2() {
		...
		boolean result = Main.contains2(list, list.get(0),
	...
	public static void test3() {
		...
		boolean result = Main.contains2(list, list.get(0),
				Comparator.comparing(Manager::getSalary)
				.thenComparing(Manager::getName)
				.thenComparing(Manager::getBonus));
		System.out.println(result);
	}
	...
	public static void test4() {
		...
		boolean result = Main.contains2(list, list.get(0),
				Comparator.comparing(CheckingAccount::getAcctId)
				.thenComparing(CheckingAccount::getBalance));
		System.out.println(result);
	}
